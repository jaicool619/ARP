...
struct user		  //Structure of the user having username and password array
{
...
extern int intoAcc();            // Function declaration of intoAcc function
extern int signUp();		 // Function declaration of registration of new user function
extern int login();		 // Function declaration of login function
extern int check_details();	 // Function declaration to check username is already present or not
extern int search_details();	 // Function declaration to search username and password and return TRUE or FALSE
